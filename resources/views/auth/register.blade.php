                ...
                <div class="card" style="min-height:640px;">
                    ...
                    <div class="card-body">
                        <div class="mb-5">
                            ...
                            <svg width="68" height="100" viewBox="0 0 68 100" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            @endif
                        <form action="{{ route('register.post')}}" method="POST" class="text-sm">
                            @csrf
                            <div class="form-floating mb-3">
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" autofocus value="{{ old('name')}}" id="floatingInput" placeholder="Arya" autocomplete="off">
                                <label for="floatingInput">Nama</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="number" name="nim" class="form-control @error('nim') is-invalid @enderror" autofocus value="{{ old('nim')}}" id="floatingInput" placeholder="209910399" autocomplete="off">
                                <label for="floatingInput">Nim</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" autofocus value="{{ old('email')}}" id="floatingInput" placeholder="name@example.com" autocomplete="off">
                            ...
                            <div class="mt-4">
                                <button class="w-100 btn btn-md text-white mb-3" type="submit" style="background-color: #F7941D;">Register</button>
                            </div>
                        </form>
                        <div class="text-center mt-4">
                            Sudah Memiliki Akun? <a href="{{ route('login.view')}}" class="text-dark"> Login</a><br>
                            <a href="#" style="color: #F7941D;">Lupa Password</a>
                        </div>
