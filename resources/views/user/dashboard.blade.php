...
<section class="container">
  <div class="row justify-content-center ">
    <div class="col-md-4" style="min-height: 650px;">
      ...
      <div class="card-body imath-body-color bg-dashboard" style="min-height: 660px;">
